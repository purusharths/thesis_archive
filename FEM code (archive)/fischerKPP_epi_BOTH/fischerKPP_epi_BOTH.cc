...
#include "fischerKPP_epi_BOTH.h"

#ifdef WITH_GPERF
#include "profiler.h"
#endif

static const char *PARAM_FILENAME = "fischerKPP_epi_BOTH.xml";
...
int main(int argc, char **argv) {
  ...
  if (argc > 2) {
      std::string arg_np = std::string(argv[2]);
      std::cout << arg_np << std::endl;
      pass_f_from_main(arg_np);
